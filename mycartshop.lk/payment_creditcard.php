...
.row-centered {
	...
	margin-right: 9px;
		...
		<meta charset="UTF-8">
		<title>mycartshop.lk Checkout</title>
...
<script type="text/javascript">
            ...
            Stripe.setPublishableKey('sk_test_zvGIFi14udKT6eSQcDOpUXtB00YmOFXTb7');  // Your Publishable Key
...
<div class="wrapper">
    <div class="container">
    <form action="payment_success.php" method="POST" id="payment-form" class="form-horizontal">
...
if ($_POST) {
Stripe::setApiKey("	
sk_test_zvGIFi14udKT6eSQcDOpUXtB00YmOFXTb7");  // Your Secret Key 
try {
...
<div class="col-25">
  <div class="container">
    <h4>Cart <span class="net_total" style="color:black" id="cart_checkout"></span><i class="fa fa-shopping-cart"></i> <b class="badge"></b></h4>
    <p><a href="cart.php">Your Product</a> <span class="net_total" id="cart_checkout"></span></p>
    <hr>
    <p>Total <span class="net_total" style="color:black"></span></p>
  </div>
</div>
<br>
<br>
