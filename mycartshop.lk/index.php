      ...
      <button type="button" onclick="document.getElementById('id03').style.display='none'" class="cancelbtn">Cancel</button>-->
					...
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
							<li><a onclick="document.getElementById('id05').style.display='block'">Company Information</a></li>
                <div id="id05" class="modal">
								...
								<p>
								Trico shipping UG is registered company in Germany, Berlin. The name TRICO is well known among all Sri Lankan expatriates live around the world to send their Cargo to Sri Lanka, started back in 1976 in London England.

We are happy to announce to all Sri Lankans live in Germany now they also can get benefit of service this great company offer to other countrymen all around the world.

When it comes to send personal baggage (by Air / Sea) and international Removal Trico is the first choice for many Sri Lankans live in other four corners of the world. The company is well known for its efficient customer service/ reliability/ professionalism/ competitive price.

You can depend on us now to get your goods to your motherland. NO third party. With THREE warehouses (Colombo / Galle/ Kurunegala) in Sri Lanka we are in a better position to serve you were ever you are in the island.

If you are planning to emigrate back to SL, contact us for a FREE quote for full house shipment in a single container just for yourself. Offer the following service, full in-house packing/ container loading / transport and shipping/ customs clearance and deliver to the door in SL

Contact us via our website or send us an email direct with your enquiry.
We also have direct deliver to door service to Philippine and Indonesia.
with branch offices around the world we can send your goods by air or by sea to any part of the world.
Please send us your inquiry.</p>
</div>
</div>
</div>
<li><a onclick="document.getElementById('id06').style.display='block'">Contact Us</a></li>
                <div id="id06" class="modal">
								...
								<p>
								<ul>
                <li>TRICO SHIPPING UG</li>
                <li>KRUMME STR. 70</li>
                <li>BERLIN 10627 GERMANY</li>
                <li>Tel : 030 81 723 723 | Fax : 030 81 723 721</li>
                <li>E-Mail : info@tricoshipping.de</li>
								</ul>
							  </p>
</div>
</div>
